...
class _HomePageState extends State<HomePage> {
  ...
  final Uri _url =
      Uri.parse('https://sandbox-flw-web-v3.herokuapp.com/pay/l3edue0nyw2v');
  ...
  Future<void> requestStoragePermission() async {
    ...
    if (storageStatus.isGranted) {
      ...
      // You may want to request permission or handle the lack of permission.
    }
    if (status.isGranted) {
      // Permission granted, you can now access storage.
    } else if (status.isDenied) {
      // Permission denied by the user.
      // You may want to explain why you need the permission or provide instructions on how to grant it.
    } else if (status.isPermanentlyDenied) {
      // Permission denied permanently, usually requires manual user action.
      // You can open app settings here for the user to enable the permission.
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          centerTitle: true,
          title: const Text('Araman Services'),
          actions: [
            IconButton(
