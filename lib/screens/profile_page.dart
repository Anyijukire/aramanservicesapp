...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void readLocal() {
    setState(() {
      print('values: ${profileProvider.getPrefs(FirestoreConstants.gender)}');
      print(
          'values: ${profileProvider.getPrefs(FirestoreConstants.phoneNumber)}');
      debugPrint('value: $FirestoreConstants');
      ...
      gender = profileProvider.getPrefs(FirestoreConstants.gender) ?? "";
    });
  ...
  void updateFirestoreData() {
    ...
    setState(() {
      isLoading = true;
      if (dialCodeDigits != "+256" && _phoneController.text != "") {
    ...
    profileProvider
      ...
      await profileProvider.setPrefs(FirestoreConstants.gender, gender);
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    for (String gndr in genderOptions)
                      RadioListTile(
                        title: Text(gndr),
                        value: gndr,
                        groupValue: gender,
